 ...
 */
final class Version20200304105806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reserve_user (reserve_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_B6CDA5545913AEBF (reserve_id), INDEX IDX_B6CDA554A76ED395 (user_id), PRIMARY KEY(reserve_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reserve_user ADD CONSTRAINT FK_B6CDA5545913AEBF FOREIGN KEY (reserve_id) REFERENCES reserve (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reserve_user ADD CONSTRAINT FK_B6CDA554A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Trajet ADD CONSTRAINT FK_2CF7ACBAC6EE5C49 FOREIGN KEY (id_utilisateur_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reserve_user DROP FOREIGN KEY FK_B6CDA5545913AEBF');
        ...
        $this->addSql('ALTER TABLE reserve_user DROP FOREIGN KEY FK_B6CDA554A76ED395');
        ...
        $this->addSql('DROP TABLE reserve_user');
