 ...
 */
final class Version20200330144138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Commentaire (id INT AUTO_INCREMENT NOT NULL, id_trajet_id INT NOT NULL, date_com DATETIME NOT NULL, contenu_com VARCHAR(255) NOT NULL, note INT NOT NULL, UNIQUE INDEX UNIQ_E16CE76B8D271404 (id_trajet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
