 ...
 */
final class Version20200331151021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Commentaire (id INT AUTO_INCREMENT NOT NULL, date_com DATETIME NOT NULL, contenu_com VARCHAR(255) NOT NULL, note INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reçois_commentaire (commentaire_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_A6B3A60BBA9CD190 (commentaire_id), INDEX IDX_A6B3A60BA76ED395 (user_id), PRIMARY KEY(commentaire_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE poste_commentaire (commentaire_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_AF562C98BA9CD190 (commentaire_id), INDEX IDX_AF562C98A76ED395 (user_id), PRIMARY KEY(commentaire_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, id_utilisateur_id INT NOT NULL, marque_voiture VARCHAR(50) NOT NULL, modele_voiture VARCHAR(50) NOT NULL, annee_voiture INT NOT NULL, couleur_voiture VARCHAR(50) NOT NULL, taille_bagages VARCHAR(25) NOT NULL, UNIQUE INDEX UNIQ_E9E2810FC6EE5C49 (id_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE reçois_commentaire ADD CONSTRAINT FK_A6B3A60BBA9CD190 FOREIGN KEY (commentaire_id) REFERENCES Commentaire (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reçois_commentaire ADD CONSTRAINT FK_A6B3A60BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE poste_commentaire ADD CONSTRAINT FK_AF562C98BA9CD190 FOREIGN KEY (commentaire_id) REFERENCES Commentaire (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE poste_commentaire ADD CONSTRAINT FK_AF562C98A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reçois_commentaire DROP FOREIGN KEY FK_A6B3A60BBA9CD190');
        $this->addSql('ALTER TABLE poste_commentaire DROP FOREIGN KEY FK_AF562C98BA9CD190');
        ...
        $this->addSql('ALTER TABLE reçois_commentaire DROP FOREIGN KEY FK_A6B3A60BA76ED395');
        $this->addSql('ALTER TABLE poste_commentaire DROP FOREIGN KEY FK_AF562C98A76ED395');
        ...
        $this->addSql('DROP TABLE reçois_commentaire');
        $this->addSql('DROP TABLE poste_commentaire');
