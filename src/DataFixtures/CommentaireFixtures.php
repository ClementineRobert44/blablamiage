...
class CommentaireFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {     
        ...
        $commentaire1->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire1')));
        ...
        $commentaire2->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire1')));
        ...
        $commentaire3->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire2')));
        ...
        $commentaire3->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire3')));
        ...
        $commentaire4->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire3')));
        ...
        $commentaire5->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire4')));
        ...
        $commentaire6->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire6')));
        ...
        $commentaire7->addIdTrajet($manager->merge($this->getReference('trajet-trajetExpire6')));
